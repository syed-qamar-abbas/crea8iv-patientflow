...
export const TRAINING_TOURS = [
  {
    ...
    steps: [
      {
        title: 'Welcome — the front-desk journey',
        body: 'This short walkthrough follows one patient end to end: register them, book a visit, raise the invoice, and collect payment. Click the highlighted item on each step to move forward, or use Next. You can replay this anytime from Help.',
        path: '/dashboard',
      },
      {
        title: 'Open the patient register',
        body: 'Every visit begins with a patient record. Click New Patient to open the registration form.',
        path: '/clients',
        selector: '[data-training="patients-new-button"]',
        actionHint: 'Click New Patient to open the form.',
      },
      {
        title: 'Enter the full name (required)',
        body: 'Type the patient’s full name here. This is a required field, and it powers search across the appointment and invoice screens later.',
        path: '/clients',
        selector: '[data-training="patient-field-name"]',
        actionHint: 'Type the name, then continue. (If the form closed, click New Patient again.)',
      },
      {
        title: 'Add the phone number (required)',
        body: 'Phone is mandatory. It is how the clinic confirms visits, sends WhatsApp reminders, and finds the patient again. Enter a valid mobile number — the form will not save until both name and phone are filled.',
        path: '/clients',
        selector: '[data-training="patient-field-phone"]',
        actionHint: 'Enter the mobile number, then continue.',
      },
      {
        title: 'Save the patient',
        body: 'With name and phone complete, save to create the record. This is the profile every appointment and invoice will link to.',
        path: '/clients',
        selector: '[data-training="patient-save-button"]',
        actionHint: 'Click Add Patient to save.',
      },
      {
        title: 'Book the visit',
        body: 'Next, create the appointment. Capture the patient, service, doctor, fee, date, and source once — billing reuses all of it automatically.',
        path: '/appointments',
        selector: '[data-training="appointments-new-button"]',
        actionHint: 'Click New Appointment to open the booking form.',
      },
      {
        title: 'Choose patient and treatment',
        body: 'Search the patient, pick the treatment, and confirm the doctor and fee. This is the data the invoice will prefill from — so it only needs to be entered here.',
        path: '/appointments',
        selector: '[data-training="appointment-patient-field"]',
        actionHint: 'Select the patient, then continue.',
      },
      {
        title: 'Create the invoice',
        body: 'After the visit, open a new invoice. Selecting the patient auto-links their most recent appointment and prefills the treatment and price for you.',
        path: '/invoices',
        selector: '[data-training="invoices-new-button"]',
        actionHint: 'Click New Invoice to open the billing form.',
      },
      {
        title: 'Confirm the auto-filled bill',
        body: 'Pick the patient and check the linked appointment: the line item and fee arrive prefilled. Set the amount paid, payment method, and any due date to complete the bill.',
        path: '/invoices',
        selector: '[data-training="invoice-patient-field"]',
        actionHint: 'Select the patient, then continue.',
      },
      {
        title: 'Review, collect, and share',
        body: 'The saved invoice lives here. From each row you can view it, mark payment, download the PDF, and send a WhatsApp follow-up. That completes the core front-desk flow.',
        path: '/invoices',
