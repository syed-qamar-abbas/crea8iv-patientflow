...
-- Idempotent SQLite migration for local development.
...
INSERT INTO Clinic (
  ...
  servicesOverview = excluded.servicesOverview,
  ...
  clinicType = excluded.clinicType;
...
INSERT INTO Staff (
  ...
  portalRole = excluded.portalRole,
